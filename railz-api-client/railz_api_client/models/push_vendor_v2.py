...
class PushVendorV2:
    ...
    Attributes:
        ...
        pass_through (Union[Unset, PushVendorV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    pass_through: Union[Unset, "PushVendorV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pass_through: Union[Unset, PushVendorV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = PushVendorV2PassThrough.from_dict(_pass_through)
        ...
        push_vendor_v2.additional_properties = d
        return push_vendor_v2
