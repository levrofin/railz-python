...
@_attrs_define
class PaymentMethodRefResponse:
    """
    Attributes:
        id (Union[Unset, str]):  Example: 3.
        name (Union[Unset, str]):  Example: Harmonized sales tax.
        type (Union[Unset, PaymentMethodRefResponseType]):  Example: creditCard.
    """

    id: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    type: Union[Unset, PaymentMethodRefResponseType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, PaymentMethodRefResponseType]
        ...
        payment_method_ref_response.additional_properties = d
        return payment_method_ref_response
