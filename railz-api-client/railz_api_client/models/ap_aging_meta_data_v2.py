...
class ApAgingMetaDataV2:
    ...
    connection_uuid: str
    business_name: str
    service_name: ApAgingMetaDataV2ServiceName
    report_id: List[str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ap_aging_meta_data_v2.additional_properties = d
        return ap_aging_meta_data_v2
