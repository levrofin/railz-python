...
T = TypeVar("T", bound="GetTransactionResponseDto")
...
class GetTransactionResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_transaction_response_dto = cls(
            pagination=pagination,
            data=data,
            count=count,
            meta=meta,
        ...
        get_transaction_response_dto.additional_properties = d
        return get_transaction_response_dto
