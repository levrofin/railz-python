...
from ..models.ar_aging_meta_data_service_name import ArAgingMetaDataServiceName, check_ar_aging_meta_data_service_name

T = TypeVar("T", bound="ArAgingMetaData")


@_attrs_define
class ArAgingMetaData:
    """
    Attributes:
        report_id (List[str]):  Example: ['5fad8a342a88364234392fb5'].
        service_name (ArAgingMetaDataServiceName):  Example: xero.
    ...
    report_id: List[str]
    service_name: ArAgingMetaDataServiceName
    business_name: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_ar_aging_meta_data_service_name(d.pop("serviceName"))
        ...
        ar_aging_meta_data.additional_properties = d
        return ar_aging_meta_data
