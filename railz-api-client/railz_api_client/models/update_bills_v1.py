...
if TYPE_CHECKING:
    from ..models.update_bill_line_item_v1 import UpdateBillLineItemV1


T = TypeVar("T", bound="UpdateBillsV1")
...
class UpdateBillsV1:
    ...
    Attributes:
        ...
        lines (Union[Unset, List['UpdateBillLineItemV1']]):
    """
    ...
    lines: Union[Unset, List["UpdateBillLineItemV1"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for lines_item_data in _lines or []:
            lines_item = UpdateBillLineItemV1.from_dict(lines_item_data)
        ...
        update_bills_v1.additional_properties = d
        return update_bills_v1
