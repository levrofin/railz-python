...
if TYPE_CHECKING:
    ...
    from ..models.push_customer_v2_pass_through import PushCustomerV2PassThrough
...
T = TypeVar("T", bound="PushCustomerV2")


@_attrs_define
class PushCustomerV2:
    """
    Attributes:
        ...
        pass_through (Union[Unset, PushCustomerV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    pass_through: Union[Unset, "PushCustomerV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pass_through: Union[Unset, PushCustomerV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = PushCustomerV2PassThrough.from_dict(_pass_through)
        ...
        push_customer_v2.additional_properties = d
        return push_customer_v2
