...
T = TypeVar("T", bound="PushCustomerV2Dto")


@_attrs_define
class PushCustomerV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_customer_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_customer_v2_dto.additional_properties = d
        return push_customer_v2_dto
