...
if TYPE_CHECKING:
    ...
    from ..models.invoice_tracking_category_ref import InvoiceTrackingCategoryRef
    from ..models.tax_rate_ref import TaxRateRef


T = TypeVar("T", bound="InvoiceLineItemsV2")


@_attrs_define
class InvoiceLineItemsV2:
    """
    Attributes:
        ...
        tracking_category_refs (Union[Unset, List['InvoiceTrackingCategoryRef']]):
    """
    ...
    tracking_category_refs: Union[Unset, List["InvoiceTrackingCategoryRef"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tracking_category_refs_item_data in _tracking_category_refs or []:
            tracking_category_refs_item = InvoiceTrackingCategoryRef.from_dict(tracking_category_refs_item_data)

            tracking_category_refs.append(tracking_category_refs_item)

        invoice_line_items_v2 = cls(
        ...
        invoice_line_items_v2.additional_properties = d
        return invoice_line_items_v2
