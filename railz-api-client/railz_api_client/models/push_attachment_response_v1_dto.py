...
T = TypeVar("T", bound="PushAttachmentResponseV1Dto")


@_attrs_define
class PushAttachmentResponseV1Dto:
    """
    Attributes:
        ...
        status (PushAttachmentResponseV1DtoStatus):  Example: pending.
        business_name (str):  Example: Railz.
        service_name (PushAttachmentResponseV1DtoServiceName):  Example: quickbooks.
        data (PushAttachmentV1):
    """

    push_communication_id: str
    requested_on: datetime.datetime
    status: PushAttachmentResponseV1DtoStatus
    business_name: str
    service_name: PushAttachmentResponseV1DtoServiceName
    data: "PushAttachmentV1"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_attachment_response_v1_dto = cls(
        ...
        push_attachment_response_v1_dto.additional_properties = d
        return push_attachment_response_v1_dto
