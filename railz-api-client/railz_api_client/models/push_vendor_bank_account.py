...
T = TypeVar("T", bound="PushVendorBankAccount")


@_attrs_define
class PushVendorBankAccount:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_vendor_bank_account.additional_properties = d
        return push_vendor_bank_account
