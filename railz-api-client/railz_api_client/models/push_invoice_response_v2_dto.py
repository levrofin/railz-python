...
from ..models.push_invoice_response_v2_dto_service_name import (
    PushInvoiceResponseV2DtoServiceName,
    check_push_invoice_response_v2_dto_service_name,
)
from ..models.push_invoice_response_v2_dto_status import (
    PushInvoiceResponseV2DtoStatus,
    check_push_invoice_response_v2_dto_status,
)
...
class PushInvoiceResponseV2Dto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_push_invoice_response_v2_dto_service_name(d.pop("serviceName"))

        push_communication_id = d.pop("pushCommunicationId")

        requested_on = isoparse(d.pop("requestedOn"))

        status = check_push_invoice_response_v2_dto_status(d.pop("status"))
