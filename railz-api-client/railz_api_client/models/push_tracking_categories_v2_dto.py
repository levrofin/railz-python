...
T = TypeVar("T", bound="PushTrackingCategoriesV2Dto")


@_attrs_define
class PushTrackingCategoriesV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_tracking_categories_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_tracking_categories_v2_dto.additional_properties = d
        return push_tracking_categories_v2_dto
