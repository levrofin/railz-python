...
if TYPE_CHECKING:
    ...
    from ..models.get_deposit_data import GetDepositData
    from ..models.pagination_meta_data import PaginationMetaData


T = TypeVar("T", bound="GetDepositResponseDto")


@_attrs_define
class GetDepositResponseDto:
    """
    Attributes:
        pagination (PaginationMetaData):
        count (float):  Example: 1.
        meta (BasicStartEndDateReportMetaData):
        data (List['GetDepositData']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetDepositData.from_dict(data_item_data)

            data.append(data_item)

        get_deposit_response_dto = cls(
            pagination=pagination,
            count=count,
            meta=meta,
            data=data,
        ...
        get_deposit_response_dto.additional_properties = d
        return get_deposit_response_dto
