...
@_attrs_define
class PushUpdateVendorConnection:
    """
    Attributes:
        business_name (str): Unique business name identifier. Example: Railz.
        service_name (PushUpdateVendorConnectionServiceName): Name of accounting platform service. Example: quickbooks.
    """

    business_name: str
    service_name: PushUpdateVendorConnectionServiceName
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_update_vendor_connection.additional_properties = d
        return push_update_vendor_connection
