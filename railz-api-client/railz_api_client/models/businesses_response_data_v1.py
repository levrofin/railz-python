...
if TYPE_CHECKING:
    from ..models.base_connections_response_data_v1 import BaseConnectionsResponseDataV1


T = TypeVar("T", bound="BusinessesResponseDataV1")


@_attrs_define
class BusinessesResponseDataV1:
    """
    Attributes:
        ...
        metadata (List[str]):  Example: [{'name': 'new business1', 'value': 'canada', 'webhookLocation': ['header',
            'body']}].
        connections (List['BaseConnectionsResponseDataV1']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for connections_item_data in _connections:
            connections_item = BaseConnectionsResponseDataV1.from_dict(connections_item_data)

            connections.append(connections_item)

        businesses_response_data_v1 = cls(
        ...
        businesses_response_data_v1.additional_properties = d
        return businesses_response_data_v1
