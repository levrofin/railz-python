...
from ..models.transactional_report_meta_data_service_name import (
    TransactionalReportMetaDataServiceName,
    check_transactional_report_meta_data_service_name,
)
...
class TransactionalReportMetaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_transactional_report_meta_data_service_name(d.pop("serviceName"))
