...
T = TypeVar("T", bound="PushBankTransfersResponseDto")


@_attrs_define
class PushBankTransfersResponseDto:
    """
    Attributes:
        ...
        status (PushBankTransfersResponseDtoStatus):  Example: pending.
        business_name (str):  Example: Railz.
        service_name (PushBankTransfersResponseDtoServiceName):  Example: xero.
        data (PushBankTransfers):
    """

    push_communication_id: str
    requested_on: datetime.datetime
    status: PushBankTransfersResponseDtoStatus
    business_name: str
    service_name: PushBankTransfersResponseDtoServiceName
    data: "PushBankTransfers"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_bank_transfers_response_dto = cls(
        ...
        push_bank_transfers_response_dto.additional_properties = d
        return push_bank_transfers_response_dto
