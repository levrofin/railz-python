...
if TYPE_CHECKING:
    ...
    from ..models.push_invoice_v2_pass_through import PushInvoiceV2PassThrough
    from ..models.subsidiary_ref_dto import SubsidiaryRefDto


T = TypeVar("T", bound="PushInvoiceV2")
...
class PushInvoiceV2:
    ...
    Attributes:
        ...
        pass_through (Union[Unset, PushInvoiceV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    customer_ref: "CustomerRefDto"
    lines: List["InvoiceLineItemV2"]
    pass_through: Union[Unset, "PushInvoiceV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pass_through: Union[Unset, PushInvoiceV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = PushInvoiceV2PassThrough.from_dict(_pass_through)
        ...
        push_invoice_v2.additional_properties = d
        return push_invoice_v2
