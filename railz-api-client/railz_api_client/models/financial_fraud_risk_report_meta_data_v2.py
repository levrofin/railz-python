...
@_attrs_define
class FinancialFraudRiskReportMetaDataV2:
    """
    Attributes:
        connection_uuid (str):  Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        business_name (str):  Example: Railz.
        service_name (FinancialFraudRiskReportMetaDataV2ServiceName):  Example: xero.
    ...
    connection_uuid: str
    business_name: str
    service_name: FinancialFraudRiskReportMetaDataV2ServiceName
    report_id: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        financial_fraud_risk_report_meta_data_v2 = cls(
        ...
        financial_fraud_risk_report_meta_data_v2.additional_properties = d
        return financial_fraud_risk_report_meta_data_v2
