...
@_attrs_define
class ReportRevenueResponse200Meta:
    """
    Attributes:
        report_id (List[str]):  Example: ['5fad8a342a88364234392fb5'].
        service_name (ReportRevenueResponse200MetaServiceName):  Example: xero.
        ...
        report_frequency (ReportRevenueResponse200MetaReportFrequency):  Example: month.
        currency (str):  Example: USD.
    """

    report_id: List[str]
    service_name: ReportRevenueResponse200MetaServiceName
    business_name: str
    end_date: str
    start_date: str
    report_frequency: ReportRevenueResponse200MetaReportFrequency
    currency: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        report_revenue_response_200_meta = cls(
            report_id=report_id,
        ...
        report_revenue_response_200_meta.additional_properties = d
        return report_revenue_response_200_meta
