...
class BatchUpdateCustomerDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for batch_item_data in _batch:
            batch_item = BatchPutCustomer.from_dict(batch_item_data)

            batch.append(batch_item)

        batch_update_customer_dto = cls(
            connection_uuid=connection_uuid,
            batch=batch,
        )

        batch_update_customer_dto.additional_properties = d
        return batch_update_customer_dto
