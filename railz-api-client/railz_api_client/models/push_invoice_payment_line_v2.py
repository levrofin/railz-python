...
T = TypeVar("T", bound="PushInvoicePaymentLineV2")


@_attrs_define
class PushInvoicePaymentLineV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_invoice_payment_line_v2 = cls(
            amount=amount,
            links=links,
            allocated_on_date=allocated_on_date,
        )

        push_invoice_payment_line_v2.additional_properties = d
        return push_invoice_payment_line_v2
