...
if TYPE_CHECKING:
    ...
    from ..models.update_bill_line_item_v2 import UpdateBillLineItemV2
    from ..models.update_bills_v2_pass_through import UpdateBillsV2PassThrough
    from ..models.vendor_ref_dto import VendorRefDto


T = TypeVar("T", bound="UpdateBillsV2")
...
class UpdateBillsV2:
    ...
    Attributes:
        ...
        lines (List['UpdateBillLineItemV2']):
        ...
        pass_through (Union[Unset, UpdateBillsV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    pass_through: Union[Unset, "UpdateBillsV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for lines_item_data in _lines:
            lines_item = UpdateBillLineItemV2.from_dict(lines_item_data)
        ...
        pass_through: Union[Unset, UpdateBillsV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = UpdateBillsV2PassThrough.from_dict(_pass_through)
        ...
        update_bills_v2.additional_properties = d
        return update_bills_v2
