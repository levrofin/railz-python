...
class GetCustomerResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetCustomerData.from_dict(data_item_data)

            data.append(data_item)

        get_customer_response_dto = cls(
            pagination=pagination,
            count=count,
            meta=meta,
            data=data,
        ...
        get_customer_response_dto.additional_properties = d
        return get_customer_response_dto
