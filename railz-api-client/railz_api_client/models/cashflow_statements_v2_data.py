...
from ..models.cashflow_statements_v2_data_section import (
    CashflowStatementsV2DataSection,
    check_cashflow_statements_v2_data_section,
)
from ..models.cashflow_statements_v2_data_sub_section import (
    CashflowStatementsV2DataSubSection,
    check_cashflow_statements_v2_data_sub_section,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CashflowStatementsV2Data")


@_attrs_define
class CashflowStatementsV2Data:
    """
    Attributes:
        section (CashflowStatementsV2DataSection):  Example: Operating Activities.
        sub_section (CashflowStatementsV2DataSubSection):  Example: Payments.
    ...
    section: CashflowStatementsV2DataSection
    sub_section: CashflowStatementsV2DataSubSection
    account: str
    value: float
    depth: float
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        section = check_cashflow_statements_v2_data_section(d.pop("section"))

        sub_section = check_cashflow_statements_v2_data_sub_section(d.pop("subSection"))
        ...
        cashflow_statements_v2_data = cls(
            section=section,
        ...
        cashflow_statements_v2_data.additional_properties = d
        return cashflow_statements_v2_data
