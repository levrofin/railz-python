...
@_attrs_define
class BillPaymentRequestMetaData:
    """
    Attributes:
        report_id (List[str]):  Example: ['5fad8a342a88364234392fb5', '5fad8a342a88364234392fb6'].
        service_name (BillPaymentRequestMetaDataServiceName):  Example: xero.
    ...
    report_id: List[str]
    service_name: BillPaymentRequestMetaDataServiceName
    business_name: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bill_payment_request_meta_data = cls(
            report_id=report_id,
        ...
        bill_payment_request_meta_data.additional_properties = d
        return bill_payment_request_meta_data
