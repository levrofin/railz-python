...
if TYPE_CHECKING:
    ...
    from ..models.reconciled_bank_transactions_v2 import ReconciledBankTransactionsV2


T = TypeVar("T", bound="BankReconciliationV2Data")


@_attrs_define
class BankReconciliationV2Data:
    """
    Attributes:
        ...
        reconciled_bank_transactions (Union[Unset, List['ReconciledBankTransactionsV2']]):
    """
    ...
    reconciled_bank_transactions: Union[Unset, List["ReconciledBankTransactionsV2"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for reconciled_bank_transactions_item_data in _reconciled_bank_transactions or []:
            reconciled_bank_transactions_item = ReconciledBankTransactionsV2.from_dict(
                reconciled_bank_transactions_item_data
            )

            reconciled_bank_transactions.append(reconciled_bank_transactions_item)

        bank_reconciliation_v2_data = cls(
        ...
        bank_reconciliation_v2_data.additional_properties = d
        return bank_reconciliation_v2_data
