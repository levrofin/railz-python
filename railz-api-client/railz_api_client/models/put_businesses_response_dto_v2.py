...
T = TypeVar("T", bound="PutBusinessesResponseDtoV2")


@_attrs_define
class PutBusinessesResponseDtoV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_businesses_response_dto_v2 = cls(
        ...
        put_businesses_response_dto_v2.additional_properties = d
        return put_businesses_response_dto_v2
