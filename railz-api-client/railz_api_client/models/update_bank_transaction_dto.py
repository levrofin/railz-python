...
T = TypeVar("T", bound="UpdateBankTransactionDto")
...
class UpdateBankTransactionDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_bank_transaction_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        update_bank_transaction_dto.additional_properties = d
        return update_bank_transaction_dto
