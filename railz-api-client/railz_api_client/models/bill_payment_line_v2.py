...
if TYPE_CHECKING:
    from ..models.link_ref_dto import LinkRefDto


T = TypeVar("T", bound="BillPaymentLineV2")


@_attrs_define
class BillPaymentLineV2:
    """
    Attributes:
        amount (Union[Unset, float]):  Example: 342.99.
        links (Union[Unset, List['LinkRefDto']]):
        allocated_on_date (Union[Unset, datetime.date]):  Example: 2021-03-29.
    """

    amount: Union[Unset, float] = UNSET
    links: Union[Unset, List["LinkRefDto"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for links_item_data in _links or []:
            links_item = LinkRefDto.from_dict(links_item_data)
        ...
        bill_payment_line_v2 = cls(
            amount=amount,
            links=links,
            allocated_on_date=allocated_on_date,
        )

        bill_payment_line_v2.additional_properties = d
        return bill_payment_line_v2
