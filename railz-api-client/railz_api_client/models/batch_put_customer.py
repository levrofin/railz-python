...
if TYPE_CHECKING:
    from ..models.batch_put_customer_pass_through import BatchPutCustomerPassThrough
...
T = TypeVar("T", bound="BatchPutCustomer")


@_attrs_define
class BatchPutCustomer:
    """
    Attributes:
        customer_ref (str): reference to the customer to be updated
        ...
        pass_through (Union[Unset, BatchPutCustomerPassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    pass_through: Union[Unset, "BatchPutCustomerPassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pass_through: Union[Unset, BatchPutCustomerPassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = BatchPutCustomerPassThrough.from_dict(_pass_through)
        ...
        batch_put_customer.additional_properties = d
        return batch_put_customer
