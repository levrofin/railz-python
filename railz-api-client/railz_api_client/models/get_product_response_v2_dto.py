...
T = TypeVar("T", bound="GetProductResponseV2Dto")


@_attrs_define
class GetProductResponseV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetProductData.from_dict(data_item_data)
        ...
        get_product_response_v2_dto = cls(
            pagination=pagination,
            data=data,
            count=count,
            meta=meta,
        ...
        get_product_response_v2_dto.additional_properties = d
        return get_product_response_v2_dto
