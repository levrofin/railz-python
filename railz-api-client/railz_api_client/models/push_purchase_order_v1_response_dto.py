...
from ..models.push_purchase_order_v1_response_dto_service_name import (
    PushPurchaseOrderV1ResponseDtoServiceName,
    check_push_purchase_order_v1_response_dto_service_name,
)
from ..models.push_purchase_order_v1_response_dto_status import (
    PushPurchaseOrderV1ResponseDtoStatus,
    check_push_purchase_order_v1_response_dto_status,
)
...
class PushPurchaseOrderV1ResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status = check_push_purchase_order_v1_response_dto_status(d.pop("status"))

        business_name = d.pop("businessName")

        service_name = check_push_purchase_order_v1_response_dto_service_name(d.pop("serviceName"))
