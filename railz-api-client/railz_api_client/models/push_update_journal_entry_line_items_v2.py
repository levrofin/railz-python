...
T = TypeVar("T", bound="PushUpdateJournalEntryLineItemsV2")


@_attrs_define
class PushUpdateJournalEntryLineItemsV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_update_journal_entry_line_items_v2 = cls(
        ...
        push_update_journal_entry_line_items_v2.additional_properties = d
        return push_update_journal_entry_line_items_v2
