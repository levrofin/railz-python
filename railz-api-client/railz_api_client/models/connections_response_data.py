...
from ..models.connections_response_data_service_name import (
    ConnectionsResponseDataServiceName,
    check_connections_response_data_service_name,
)
...
T = TypeVar("T", bound="ConnectionsResponseData")
...
class ConnectionsResponseData:
    ...
    Attributes:
        ...
        service_name (ConnectionsResponseDataServiceName):  Example: xero.
    ...
    connection_uuid: str
    service_name: ConnectionsResponseDataServiceName
    status: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_connections_response_data_service_name(d.pop("serviceName"))
        ...
        connections_response_data.additional_properties = d
        return connections_response_data
