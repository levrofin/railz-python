...
T = TypeVar("T", bound="PushCustomerBankAccountDto")


@_attrs_define
class PushCustomerBankAccountDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_customer_bank_account_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_customer_bank_account_dto.additional_properties = d
        return push_customer_bank_account_dto
