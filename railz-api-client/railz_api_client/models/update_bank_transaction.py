...
T = TypeVar("T", bound="UpdateBankTransaction")


@_attrs_define
class UpdateBankTransaction:
    """
    Attributes:
        transaction_type (UpdateBankTransactionTransactionType):  Example: payment.
        pass_through (Union[Unset, UpdateBankTransactionPassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    transaction_type: UpdateBankTransactionTransactionType
    pass_through: Union[Unset, "UpdateBankTransactionPassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_pass_through, Unset):
            ...
            pass_through = UpdateBankTransactionPassThrough.from_dict(_pass_through)
        ...
        update_bank_transaction.additional_properties = d
        return update_bank_transaction
