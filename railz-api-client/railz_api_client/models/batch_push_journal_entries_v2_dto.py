...
T = TypeVar("T", bound="BatchPushJournalEntriesV2Dto")


@_attrs_define
class BatchPushJournalEntriesV2Dto:
    """
    Attributes:
        connection_uuid (str): Unique connection identifier. Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        batch (List['PushJournalEntriesV2']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for batch_item_data in _batch:
            batch_item = PushJournalEntriesV2.from_dict(batch_item_data)

            batch.append(batch_item)

        batch_push_journal_entries_v2_dto = cls(
            connection_uuid=connection_uuid,
            batch=batch,
        )

        batch_push_journal_entries_v2_dto.additional_properties = d
        return batch_push_journal_entries_v2_dto
