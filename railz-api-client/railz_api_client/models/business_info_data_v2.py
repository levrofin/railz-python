...
if TYPE_CHECKING:
    from ..models.business_info_address_v2 import BusinessInfoAddressV2
    from ..models.business_info_currency_ref import BusinessInfoCurrencyRef
    from ..models.business_info_data_v2_pass_through import BusinessInfoDataV2PassThrough
    from ..models.business_info_subsidiary_ref import BusinessInfoSubsidiaryRef


T = TypeVar("T", bound="BusinessInfoDataV2")
...
class BusinessInfoDataV2:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_mailing_address, Unset):
            ...
            mailing_address = BusinessInfoAddressV2.from_dict(_mailing_address)
        ...
        business_info_data_v2.additional_properties = d
        return business_info_data_v2
