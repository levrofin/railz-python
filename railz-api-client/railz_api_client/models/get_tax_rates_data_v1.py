...
if TYPE_CHECKING:
    from ..models.tax_rate_component_v1 import TaxRateComponentV1


T = TypeVar("T", bound="GetTaxRatesDataV1")


@_attrs_define
class GetTaxRatesDataV1:
    """
    Attributes:
        id (str):  Example: 1.
        ...
        components (Union[Unset, List['TaxRateComponentV1']]):
    """
    ...
    components: Union[Unset, List["TaxRateComponentV1"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for components_item_data in _components or []:
            components_item = TaxRateComponentV1.from_dict(components_item_data)

            components.append(components_item)

        get_tax_rates_data_v1 = cls(
            id=id,
            name=name,
            code=code,
        ...
        get_tax_rates_data_v1.additional_properties = d
        return get_tax_rates_data_v1
