...
from ..models.push_bill_line_item_v2_billable_status import (
    PushBillLineItemV2BillableStatus,
    check_push_bill_line_item_v2_billable_status,
)
...
class PushBillLineItemV2:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_billable_status, Unset):
            ...
            billable_status = check_push_bill_line_item_v2_billable_status(_billable_status)
