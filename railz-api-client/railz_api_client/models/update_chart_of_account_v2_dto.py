...
T = TypeVar("T", bound="UpdateChartOfAccountV2Dto")


@_attrs_define
class UpdateChartOfAccountV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_chart_of_account_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        update_chart_of_account_v2_dto.additional_properties = d
        return update_chart_of_account_v2_dto
