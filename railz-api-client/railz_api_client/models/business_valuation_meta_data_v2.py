...
class BusinessValuationMetaDataV2:
    ...
    connection_uuid: str
    business_name: str
    service_name: BusinessValuationMetaDataV2ServiceName
    report_id: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        business_valuation_meta_data_v2 = cls(
        ...
        business_valuation_meta_data_v2.additional_properties = d
        return business_valuation_meta_data_v2
