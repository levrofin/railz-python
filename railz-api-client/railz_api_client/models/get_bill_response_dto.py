...
if TYPE_CHECKING:
    from ..models.get_bill_data import GetBillData
...
T = TypeVar("T", bound="GetBillResponseDto")


@_attrs_define
class GetBillResponseDto:
    """
    Attributes:
        pagination (PaginationMetaData):
        count (float):  Example: 1.
        meta (TransactionalReportMetaData):
        data (List['GetBillData']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetBillData.from_dict(data_item_data)

            data.append(data_item)

        get_bill_response_dto = cls(
            pagination=pagination,
            count=count,
            meta=meta,
            data=data,
        ...
        get_bill_response_dto.additional_properties = d
        return get_bill_response_dto
