...
T = TypeVar("T", bound="PutVendorV1ResponseDto")


@_attrs_define
class PutVendorV1ResponseDto:
    """
    Attributes:
        ...
        status (PutVendorV1ResponseDtoStatus):  Example: pending.
        business_name (str):  Example: Railz.
        service_name (PutVendorV1ResponseDtoServiceName):  Example: quickbooks.
        data (PutVendorV1):
    """

    push_communication_id: str
    requested_on: datetime.datetime
    status: PutVendorV1ResponseDtoStatus
    business_name: str
    service_name: PutVendorV1ResponseDtoServiceName
    data: "PutVendorV1"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_vendor_v1_response_dto = cls(
        ...
        put_vendor_v1_response_dto.additional_properties = d
        return put_vendor_v1_response_dto
