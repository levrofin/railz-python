...
from ..models.update_bill_payment_v2_payment_method import (
    UpdateBillPaymentV2PaymentMethod,
    check_update_bill_payment_v2_payment_method,
)
...
if TYPE_CHECKING:
    ...
    from ..models.update_bill_payment_v2_pass_through import UpdateBillPaymentV2PassThrough
    from ..models.vendor_ref_dto import VendorRefDto


T = TypeVar("T", bound="UpdateBillPaymentV2")


@_attrs_define
class UpdateBillPaymentV2:
    """
    Attributes:
        ...
        payment_method (Union[Unset, UpdateBillPaymentV2PaymentMethod]):  Example: creditCard.
        payment_method_ref (Union[Unset, PaymentMethodRefDto]):
        pass_through (Union[Unset, UpdateBillPaymentV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
    ...
    payment_method: Union[Unset, UpdateBillPaymentV2PaymentMethod] = UNSET
    payment_method_ref: Union[Unset, "PaymentMethodRefDto"] = UNSET
    pass_through: Union[Unset, "UpdateBillPaymentV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        payment_method: Union[Unset, UpdateBillPaymentV2PaymentMethod]
        if isinstance(_payment_method, Unset):
            payment_method = UNSET
        else:
            payment_method = check_update_bill_payment_v2_payment_method(_payment_method)
        ...
        pass_through: Union[Unset, UpdateBillPaymentV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = UpdateBillPaymentV2PassThrough.from_dict(_pass_through)

        update_bill_payment_v2 = cls(
        ...
        update_bill_payment_v2.additional_properties = d
        return update_bill_payment_v2
