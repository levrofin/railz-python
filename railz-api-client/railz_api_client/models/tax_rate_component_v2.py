...
T = TypeVar("T", bound="TaxRateComponentV2")


@_attrs_define
class TaxRateComponentV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tax_rate_component_v2.additional_properties = d
        return tax_rate_component_v2
