...
T = TypeVar("T", bound="PushChartOfAccountV2Dto")


@_attrs_define
class PushChartOfAccountV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_chart_of_account_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_chart_of_account_v2_dto.additional_properties = d
        return push_chart_of_account_v2_dto
