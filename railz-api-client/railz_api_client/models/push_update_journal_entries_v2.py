...
if TYPE_CHECKING:
    ...
    from ..models.push_update_journal_entries_v2_pass_through import PushUpdateJournalEntriesV2PassThrough
...
T = TypeVar("T", bound="PushUpdateJournalEntriesV2")


@_attrs_define
class PushUpdateJournalEntriesV2:
    """
    Attributes:
        ...
        pass_through (Union[Unset, PushUpdateJournalEntriesV2PassThrough]):  Example: {'CustomField': [{'DefinitionId':
    ...
    pass_through: Union[Unset, "PushUpdateJournalEntriesV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pass_through: Union[Unset, PushUpdateJournalEntriesV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = PushUpdateJournalEntriesV2PassThrough.from_dict(_pass_through)

        push_update_journal_entries_v2 = cls(
        ...
        push_update_journal_entries_v2.additional_properties = d
        return push_update_journal_entries_v2
