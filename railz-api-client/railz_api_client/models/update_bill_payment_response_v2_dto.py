...
from ..models.update_bill_payment_response_v2_dto_service_name import (
    UpdateBillPaymentResponseV2DtoServiceName,
    check_update_bill_payment_response_v2_dto_service_name,
)
from ..models.update_bill_payment_response_v2_dto_status import (
    UpdateBillPaymentResponseV2DtoStatus,
    check_update_bill_payment_response_v2_dto_status,
)
...
class UpdateBillPaymentResponseV2Dto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_update_bill_payment_response_v2_dto_service_name(d.pop("serviceName"))

        push_communication_id = d.pop("pushCommunicationId")

        requested_on = isoparse(d.pop("requestedOn"))

        status = check_update_bill_payment_response_v2_dto_status(d.pop("status"))
