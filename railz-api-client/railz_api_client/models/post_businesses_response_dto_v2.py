...
T = TypeVar("T", bound="PostBusinessesResponseDtoV2")


@_attrs_define
class PostBusinessesResponseDtoV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_businesses_response_dto_v2 = cls(
        ...
        post_businesses_response_dto_v2.additional_properties = d
        return post_businesses_response_dto_v2
