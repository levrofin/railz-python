...
from ..models.update_inventory_v2_type import UpdateInventoryV2Type, check_update_inventory_v2_type
...
if TYPE_CHECKING:
    ...
    from ..models.update_inventory_v2_pass_through import UpdateInventoryV2PassThrough


T = TypeVar("T", bound="UpdateInventoryV2")


@_attrs_define
class UpdateInventoryV2:
    """
    Attributes:
        name (str):  Example: White golf balls..
        code (Union[Unset, str]):  Example: GOL-W.
        type (Union[Unset, UpdateInventoryV2Type]):  Example: inventory.
        ...
        pass_through (Union[Unset, UpdateInventoryV2PassThrough]):  Example: {'CustomField': [{'DefinitionId': '1',
            'StringValue': 'my custom value', 'Name': 'Field One'}]}.
    """

    name: str
    code: Union[Unset, str] = UNSET
    type: Union[Unset, UpdateInventoryV2Type] = UNSET
    ...
    pass_through: Union[Unset, "UpdateInventoryV2PassThrough"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, UpdateInventoryV2Type]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = check_update_inventory_v2_type(_type)
        ...
        pass_through: Union[Unset, UpdateInventoryV2PassThrough]
        if isinstance(_pass_through, Unset):
            pass_through = UNSET
        else:
            pass_through = UpdateInventoryV2PassThrough.from_dict(_pass_through)

        update_inventory_v2 = cls(
            name=name,
            code=code,
            type=type,
        ...
        update_inventory_v2.additional_properties = d
        return update_inventory_v2
