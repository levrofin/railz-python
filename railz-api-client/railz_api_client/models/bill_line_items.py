...
from ..models.bill_line_items_billable_status import BillLineItemsBillableStatus, check_bill_line_items_billable_status
...
class BillLineItems:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_billable_status, Unset):
            ...
            billable_status = check_bill_line_items_billable_status(_billable_status)
