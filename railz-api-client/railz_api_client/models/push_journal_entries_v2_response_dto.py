...
from ..models.push_journal_entries_v2_response_dto_service_name import (
    PushJournalEntriesV2ResponseDtoServiceName,
    check_push_journal_entries_v2_response_dto_service_name,
)
from ..models.push_journal_entries_v2_response_dto_status import (
    PushJournalEntriesV2ResponseDtoStatus,
    check_push_journal_entries_v2_response_dto_status,
)
...
class PushJournalEntriesV2ResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_push_journal_entries_v2_response_dto_service_name(d.pop("serviceName"))

        push_communication_id = d.pop("pushCommunicationId")

        requested_on = isoparse(d.pop("requestedOn"))

        status = check_push_journal_entries_v2_response_dto_status(d.pop("status"))
