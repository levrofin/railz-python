...
@_attrs_define
class CreditScoresReportMetaData:
    """
    Attributes:
        report_id (str):  Example: 5fad8a342a88364234392fb5.
        service_name (CreditScoresReportMetaDataServiceName):  Example: xero.
    ...
    report_id: str
    service_name: CreditScoresReportMetaDataServiceName
    business_name: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credit_scores_report_meta_data = cls(
            report_id=report_id,
        ...
        credit_scores_report_meta_data.additional_properties = d
        return credit_scores_report_meta_data
