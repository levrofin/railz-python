...
T = TypeVar("T", bound="PushBankAccountV2Dto")


@_attrs_define
class PushBankAccountV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_bank_account_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_bank_account_v2_dto.additional_properties = d
        return push_bank_account_v2_dto
