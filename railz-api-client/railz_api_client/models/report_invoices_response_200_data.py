...
T = TypeVar("T", bound="ReportInvoicesResponse200Data")


@_attrs_define
class ReportInvoicesResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        report_invoices_response_200_data = cls(
            unpaid_amount=unpaid_amount,
            paid_amount=paid_amount,
            overdue_amount=overdue_amount,
        )

        report_invoices_response_200_data.additional_properties = d
        return report_invoices_response_200_data
