...
@_attrs_define
class ReportBillsResponse200Meta:
    """
    Attributes:
        report_id (List[str]):  Example: ['5fad8a342a88364234392fb5'].
        service_name (ReportBillsResponse200MetaServiceName):  Example: xero.
    ...
    report_id: List[str]
    service_name: ReportBillsResponse200MetaServiceName
    business_name: str
    end_date: str
    start_date: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        report_bills_response_200_meta = cls(
            report_id=report_id,
        ...
        report_bills_response_200_meta.additional_properties = d
        return report_bills_response_200_meta
