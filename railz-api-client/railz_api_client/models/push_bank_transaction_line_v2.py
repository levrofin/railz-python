...
T = TypeVar("T", bound="PushBankTransactionLineV2")


@_attrs_define
class PushBankTransactionLineV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_bank_transaction_line_v2 = cls(
        ...
        push_bank_transaction_line_v2.additional_properties = d
        return push_bank_transaction_line_v2
