...
if TYPE_CHECKING:
    ...
    from ..models.get_order_data import GetOrderData
    from ..models.pagination_meta_data import PaginationMetaData


T = TypeVar("T", bound="GetOrderResponseV2Dto")


@_attrs_define
class GetOrderResponseV2Dto:
    """
    Attributes:
        pagination (PaginationMetaData):
        data (List['GetOrderData']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetOrderData.from_dict(data_item_data)
        ...
        get_order_response_v2_dto.additional_properties = d
        return get_order_response_v2_dto
