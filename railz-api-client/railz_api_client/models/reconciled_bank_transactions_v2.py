...
from ..models.reconciled_bank_transactions_v2_accounting_transaction_type import (
    ReconciledBankTransactionsV2AccountingTransactionType,
    check_reconciled_bank_transactions_v2_accounting_transaction_type,
)
...
T = TypeVar("T", bound="ReconciledBankTransactionsV2")


@_attrs_define
class ReconciledBankTransactionsV2:
    """
    Attributes:
        ...
        accounting_transaction_id (Union[Unset, str]):  Example: 13.
        accounting_transaction_type (Union[Unset, ReconciledBankTransactionsV2AccountingTransactionType]):
    ...
    accounting_transaction_id: Union[Unset, str] = UNSET
    accounting_transaction_type: Union[Unset, ReconciledBankTransactionsV2AccountingTransactionType] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if accounting_transaction_id is not UNSET:
            field_dict["accountingTransactionId"] = accounting_transaction_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accounting_transaction_id = d.pop("accountingTransactionId", UNSET)
        ...
        if isinstance(_accounting_transaction_type, Unset):
            ...
            accounting_transaction_type = check_reconciled_bank_transactions_v2_accounting_transaction_type(
        ...
        reconciled_bank_transactions_v2 = cls(
            id=id,
            date=date,
            amount=amount,
        ...
        reconciled_bank_transactions_v2.additional_properties = d
        return reconciled_bank_transactions_v2
