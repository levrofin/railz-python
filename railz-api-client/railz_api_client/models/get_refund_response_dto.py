...
if TYPE_CHECKING:
    ...
    from ..models.get_refund_data_v1 import GetRefundDataV1
    from ..models.pagination_meta_data import PaginationMetaData


T = TypeVar("T", bound="GetRefundResponseDto")


@_attrs_define
class GetRefundResponseDto:
    """
    Attributes:
        pagination (PaginationMetaData):
        count (float):  Example: 1.
        meta (BasicStartEndDateReportMetaData):
        data (List['GetRefundDataV1']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = GetRefundDataV1.from_dict(data_item_data)

            data.append(data_item)

        get_refund_response_dto = cls(
            pagination=pagination,
            count=count,
            meta=meta,
            data=data,
        ...
        get_refund_response_dto.additional_properties = d
        return get_refund_response_dto
