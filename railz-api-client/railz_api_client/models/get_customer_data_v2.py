...
T = TypeVar("T", bound="GetCustomerDataV2")


@_attrs_define
class GetCustomerDataV2:
    """
    Attributes:
        id (str):  Example: 1.
        status (GetCustomerDataV2Status):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_customer_data_v2.additional_properties = d
        return get_customer_data_v2
