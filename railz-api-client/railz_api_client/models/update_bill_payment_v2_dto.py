...
T = TypeVar("T", bound="UpdateBillPaymentV2Dto")


@_attrs_define
class UpdateBillPaymentV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_bill_payment_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        update_bill_payment_v2_dto.additional_properties = d
        return update_bill_payment_v2_dto
