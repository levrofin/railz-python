...
T = TypeVar("T", bound="PushUpdateJournalEntriesV2ResponseDto")


@_attrs_define
class PushUpdateJournalEntriesV2ResponseDto:
    """
    Attributes:
        connection_uuid (str):  Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        business_name (str):  Example: Railz.
        service_name (PushUpdateJournalEntriesV2ResponseDtoServiceName):  Example: xero.
        ...
        status (PushUpdateJournalEntriesV2ResponseDtoStatus):  Example: pending.
        data (PushUpdateJournalEntriesV2):
    """

    connection_uuid: str
    business_name: str
    service_name: PushUpdateJournalEntriesV2ResponseDtoServiceName
    push_communication_id: str
    requested_on: datetime.datetime
    status: PushUpdateJournalEntriesV2ResponseDtoStatus
    data: "PushUpdateJournalEntriesV2"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_update_journal_entries_v2_response_dto = cls(
        ...
        push_update_journal_entries_v2_response_dto.additional_properties = d
        return push_update_journal_entries_v2_response_dto
