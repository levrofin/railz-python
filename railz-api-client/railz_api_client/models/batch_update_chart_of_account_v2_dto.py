...
T = TypeVar("T", bound="BatchUpdateChartOfAccountV2Dto")


@_attrs_define
class BatchUpdateChartOfAccountV2Dto:
    """
    Attributes:
        connection_uuid (str): Unique connection identifier. Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        batch (List['BatchUpdateChartOfAccount']):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for batch_item_data in _batch:
            batch_item = BatchUpdateChartOfAccount.from_dict(batch_item_data)

            batch.append(batch_item)

        batch_update_chart_of_account_v2_dto = cls(
            connection_uuid=connection_uuid,
            batch=batch,
        )

        batch_update_chart_of_account_v2_dto.additional_properties = d
        return batch_update_chart_of_account_v2_dto
