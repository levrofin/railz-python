...
T = TypeVar("T", bound="InvoiceCreditNoteLineV2")


@_attrs_define
class InvoiceCreditNoteLineV2:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_credit_note_line_v2 = cls(
        ...
        invoice_credit_note_line_v2.additional_properties = d
        return invoice_credit_note_line_v2
