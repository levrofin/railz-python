...
from ..models.customer_vendor_address_type import CustomerVendorAddressType, check_customer_vendor_address_type
from ..types import UNSET, Unset

T = TypeVar("T", bound="CustomerVendorAddress")


@_attrs_define
class CustomerVendorAddress:
    """
    Attributes:
        ...
        type (Union[Unset, CustomerVendorAddressType]):
    """
    ...
    type: Union[Unset, CustomerVendorAddressType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = check_customer_vendor_address_type(_type)

        customer_vendor_address = cls(
            line1=line1,
            line2=line2,
            city=city,
            region=region,
        ...
        customer_vendor_address.additional_properties = d
        return customer_vendor_address
