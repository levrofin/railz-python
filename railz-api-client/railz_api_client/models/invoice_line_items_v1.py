...
T = TypeVar("T", bound="InvoiceLineItemsV1")


@_attrs_define
class InvoiceLineItemsV1:
    """
    Attributes:
        ...
        discount_percentage (Union[Unset, str]):  Example: 10.5.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_line_items_v1.additional_properties = d
        return invoice_line_items_v1
