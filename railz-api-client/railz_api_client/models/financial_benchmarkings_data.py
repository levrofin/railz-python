...
T = TypeVar("T", bound="FinancialBenchmarkingsData")


@_attrs_define
class FinancialBenchmarkingsData:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        ratios: Dict[str, Any]
        if isinstance(self.ratios, SummaryStatisticsData):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_ratios(data: object) -> "SummaryStatisticsData":
            if not isinstance(data, dict):
                raise TypeError()
        ...
        ratios = _parse_ratios(d.pop("ratios"))

        financial_benchmarkings_data = cls(
            section=section,
        ...
        financial_benchmarkings_data.additional_properties = d
        return financial_benchmarkings_data
