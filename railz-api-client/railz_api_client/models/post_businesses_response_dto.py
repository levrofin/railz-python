...
T = TypeVar("T", bound="PostBusinessesResponseDto")


@_attrs_define
class PostBusinessesResponseDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_businesses_response_dto = cls(
        ...
        post_businesses_response_dto.additional_properties = d
        return post_businesses_response_dto
