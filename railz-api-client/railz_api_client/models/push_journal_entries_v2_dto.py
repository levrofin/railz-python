...
T = TypeVar("T", bound="PushJournalEntriesV2Dto")


@_attrs_define
class PushJournalEntriesV2Dto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        push_journal_entries_v2_dto = cls(
            connection_uuid=connection_uuid,
            data=data,
        )

        push_journal_entries_v2_dto.additional_properties = d
        return push_journal_entries_v2_dto
