...
@_attrs_define
class BankTransactionsAccountingReportMetaData:
    """
    Attributes:
        connection_uuid (str):  Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        business_name (str):  Example: Railz.
        service_name (BankTransactionsAccountingReportMetaDataServiceName):  Example: xero.
    ...
    connection_uuid: str
    business_name: str
    service_name: BankTransactionsAccountingReportMetaDataServiceName
    report_id: List[str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bank_transactions_accounting_report_meta_data = cls(
        ...
        bank_transactions_accounting_report_meta_data.additional_properties = d
        return bank_transactions_accounting_report_meta_data
