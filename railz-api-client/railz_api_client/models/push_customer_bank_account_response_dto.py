...
from ..models.push_customer_bank_account_response_dto_service_name import (
    PushCustomerBankAccountResponseDtoServiceName,
    check_push_customer_bank_account_response_dto_service_name,
)
from ..models.push_customer_bank_account_response_dto_status import (
    PushCustomerBankAccountResponseDtoStatus,
    check_push_customer_bank_account_response_dto_status,
)
...
class PushCustomerBankAccountResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_push_customer_bank_account_response_dto_service_name(d.pop("serviceName"))

        push_communication_id = d.pop("pushCommunicationId")

        requested_on = isoparse(d.pop("requestedOn"))

        status = check_push_customer_bank_account_response_dto_status(d.pop("status"))
