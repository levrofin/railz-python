...
from ..models.income_statements_v2_data_section import (
    IncomeStatementsV2DataSection,
    check_income_statements_v2_data_section,
)
from ..models.income_statements_v2_data_sub_section import (
    IncomeStatementsV2DataSubSection,
    check_income_statements_v2_data_sub_section,
)
...
class IncomeStatementsV2Data:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        section = check_income_statements_v2_data_section(d.pop("section"))

        sub_section = check_income_statements_v2_data_sub_section(d.pop("subSection"))
