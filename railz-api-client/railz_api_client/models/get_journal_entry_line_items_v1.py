...
T = TypeVar("T", bound="GetJournalEntryLineItemsV1")


@_attrs_define
class GetJournalEntryLineItemsV1:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_journal_entry_line_items_v1 = cls(
        ...
        get_journal_entry_line_items_v1.additional_properties = d
        return get_journal_entry_line_items_v1
