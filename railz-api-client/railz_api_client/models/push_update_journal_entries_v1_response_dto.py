...
from ..models.push_update_journal_entries_v1_response_dto_service_name import (
    ...
    check_push_update_journal_entries_v1_response_dto_service_name,
)
from ..models.push_update_journal_entries_v1_response_dto_status import (
    PushUpdateJournalEntriesV1ResponseDtoStatus,
    check_push_update_journal_entries_v1_response_dto_status,
)
...
class PushUpdateJournalEntriesV1ResponseDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status = check_push_update_journal_entries_v1_response_dto_status(d.pop("status"))

        business_name = d.pop("businessName")

        service_name = check_push_update_journal_entries_v1_response_dto_service_name(d.pop("serviceName"))
