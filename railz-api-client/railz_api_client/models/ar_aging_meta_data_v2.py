...
from ..models.ar_aging_meta_data_v2_service_name import (
    ArAgingMetaDataV2ServiceName,
    check_ar_aging_meta_data_v2_service_name,
)

T = TypeVar("T", bound="ArAgingMetaDataV2")


@_attrs_define
class ArAgingMetaDataV2:
    """
    Attributes:
        connection_uuid (str):  Example: CON-396d5daa-26b2-4979-89b6-cafb2c298155.
        business_name (str):  Example: Railz.
        service_name (ArAgingMetaDataV2ServiceName):  Example: xero.
    ...
    connection_uuid: str
    business_name: str
    service_name: ArAgingMetaDataV2ServiceName
    report_id: List[str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        service_name = check_ar_aging_meta_data_v2_service_name(d.pop("serviceName"))
        ...
        ar_aging_meta_data_v2.additional_properties = d
        return ar_aging_meta_data_v2
