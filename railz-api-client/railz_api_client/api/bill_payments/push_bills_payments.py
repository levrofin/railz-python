...
from ...models.push_bill_payment_response_v2_dto import PushBillPaymentResponseV2Dto
from ...models.push_bill_payment_v2_dto import PushBillPaymentV2Dto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushBillPaymentV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushBillPaymentResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushBillPaymentResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushBillPaymentResponseV2Dto]
    """
