...
from ...models.update_bank_transaction_dto import UpdateBankTransactionDto
from ...models.update_bank_transaction_response_dto import UpdateBankTransactionResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/v2/accounting/bankTransactions/{id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = UpdateBankTransactionResponseDto.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateBankTransactionResponseDto]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateBankTransactionResponseDto]
    """
