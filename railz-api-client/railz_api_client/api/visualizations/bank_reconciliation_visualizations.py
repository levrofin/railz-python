...
from ...models.bank_reconciliation_response_v2_dto import BankReconciliationResponseV2Dto
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/v2/visualizations/bankReconciliation",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BankReconciliationResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = BankReconciliationResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    `oracleNetsuite` `dynamicsBusinessCentral`
    ...
    Returns:
        Response[Union[Any, BankReconciliationResponseV2Dto, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BankReconciliationResponseV2Dto, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
