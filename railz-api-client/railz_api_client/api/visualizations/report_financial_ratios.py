...
from ...models.report_financial_ratios_report_frequency import ReportFinancialRatiosReportFrequency
from ...models.report_financial_ratios_response_200 import ReportFinancialRatiosResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/v2/visualizations/financialRatios",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ReportFinancialRatiosResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, ReportFinancialRatiosResponse200]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, ReportFinancialRatiosResponse200]
    """
