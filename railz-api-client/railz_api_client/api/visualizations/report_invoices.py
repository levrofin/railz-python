...
from ...models.report_invoices_response_200 import ReportInvoicesResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/v2/visualizations/invoices",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ReportInvoicesResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, ReportInvoicesResponse200]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDto, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, ReportInvoicesResponse200]
    """
