...
from ...models.push_options_data_type import PushOptionsDataType
from ...models.push_options_response_dto import PushOptionsResponseDto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushOptionsResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        connection_uuid (str):
        data_type (Union[Unset, PushOptionsDataType]):
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushOptionsResponseDto]]
    """
