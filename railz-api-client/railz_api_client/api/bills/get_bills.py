...
from ...models.get_bill_response_v2_dto import GetBillResponseV2Dto
from ...models.get_bills_status import GetBillsStatus
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, GetBillsStatus] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBillResponseV2Dto
    ]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetBillResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetBillResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (Union[Unset, GetBillsStatus]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBillResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBillResponseV2Dto]
    """
