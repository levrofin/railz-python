...
from ...models.batch_update_chart_of_account_v2_dto import BatchUpdateChartOfAccountV2Dto
from ...models.batch_update_chart_of_account_v2_response_dto import BatchUpdateChartOfAccountV2ResponseDto
...
def _get_kwargs(
    *,
    body: BatchUpdateChartOfAccountV2Dto,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": "/v2/accounting/accounts/batch",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BatchUpdateChartOfAccountV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[BatchUpdateChartOfAccountV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[BatchUpdateChartOfAccountV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
