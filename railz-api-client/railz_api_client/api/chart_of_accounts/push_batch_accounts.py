...
from ...models.batch_push_chart_of_account_v2_dto import BatchPushChartOfAccountV2Dto
from ...models.batch_push_chart_of_account_v2_response_dto import BatchPushChartOfAccountV2ResponseDto
...
def _get_kwargs(
    *,
    body: BatchPushChartOfAccountV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BatchPushChartOfAccountV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[BatchPushChartOfAccountV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[BatchPushChartOfAccountV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
