...
from ...models.update_chart_of_account_v2_dto import UpdateChartOfAccountV2Dto
from ...models.update_chart_of_account_v2_response_dto import UpdateChartOfAccountV2ResponseDto
...
def _get_kwargs(
    id: str,
    *,
    body: UpdateChartOfAccountV2Dto,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/v2/accounting/accounts/{id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = UpdateChartOfAccountV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateChartOfAccountV2ResponseDto]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateChartOfAccountV2ResponseDto]
    """
