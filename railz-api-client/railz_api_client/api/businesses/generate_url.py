...
from ...models.error_404_dto import Error404Dto
from ...models.error_500_response_dto import Error500ResponseDto
from ...models.generate_url_body import GenerateUrlBody
from ...models.generate_url_response_201 import GenerateUrlResponse201
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = GenerateUrlResponse201.from_dict(response.json())
    ...
    if response.status_code == HTTPStatus.NOT_FOUND:
        response_404 = Error404Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error404Dto, Error500ResponseDto, GenerateUrlResponse201]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error404Dto, Error500ResponseDto, GenerateUrlResponse201]
    """
