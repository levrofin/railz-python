...
from ...models.connection_migration_dto import ConnectionMigrationDto
from ...models.connection_migration_response_dto import ConnectionMigrationResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/v2/businesses/{uuid}/connection/migrate",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = ConnectionMigrationResponseDto.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ConnectionMigrationResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ConnectionMigrationResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
