...
def _get_kwargs(
    *,
    connection_uuid: str,
    accounting_method: Union[Unset, CashflowStatementsAccountingMethod] = "accrual",
    report_frequency: CashflowStatementsReportFrequency,
    start_date: Union[Unset, str] = UNSET,
    end_date: Union[Unset, str] = UNSET,
    section: Union[Unset, CashflowStatementsSection] = UNSET,
    sub_section: Union[Unset, CashflowStatementsSubSection] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = CashflowStatementsResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = CashflowStatementsResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        connection_uuid (str):
        accounting_method (Union[Unset, CashflowStatementsAccountingMethod]):  Default: 'accrual'.
        report_frequency (CashflowStatementsReportFrequency):
        start_date (Union[Unset, str]):
        end_date (Union[Unset, str]):
        section (Union[Unset, CashflowStatementsSection]):
        sub_section (Union[Unset, CashflowStatementsSubSection]):
    ...
    Returns:
        Response[Union[Any, CashflowStatementsResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, CashflowStatementsResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
