...
from ...models.push_deposit_v2_dto import PushDepositV2Dto
from ...models.push_deposit_v2_response_dto import PushDepositV2ResponseDto
from ...types import Response


def _get_kwargs(
    *,
    body: PushDepositV2Dto,
) -> Dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushDepositV2ResponseDto
    ]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PushDepositV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushDepositV2ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushDepositV2ResponseDto]
    """
