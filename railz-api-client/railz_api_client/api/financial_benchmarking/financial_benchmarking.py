...
def _get_kwargs(
    *,
    ...
    time_in_business: Union[Unset, FinancialBenchmarkingTimeInBusiness] = UNSET,
    ...
    json_time_in_business: Union[Unset, int] = UNSET
    if not isinstance(time_in_business, Unset):
        json_time_in_business = time_in_business

    params["timeInBusiness"] = json_time_in_business
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = FinancialBenchmarkingsResponseDto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = FinancialBenchmarkingsResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """List of Financial Benchmarks

    Args:
        industry_code (Union[Unset, str]):
        region (Union[Unset, str]):
        time_in_business (Union[Unset, FinancialBenchmarkingTimeInBusiness]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, FinancialBenchmarkingsResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, FinancialBenchmarkingsResponseDto]
    """
