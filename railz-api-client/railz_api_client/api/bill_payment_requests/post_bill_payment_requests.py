...
from ...models.post_bill_payment_request_response_v2_dto import PostBillPaymentRequestResponseV2Dto
from ...models.post_bill_payment_request_v2_dto import PostBillPaymentRequestV2Dto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PostBillPaymentRequestV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PostBillPaymentRequestResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PostBillPaymentRequestResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PostBillPaymentRequestResponseV2Dto]
    """
