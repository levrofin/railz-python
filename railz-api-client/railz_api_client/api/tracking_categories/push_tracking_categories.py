...
from ...models.push_tracking_categories_response_v2_dto import PushTrackingCategoriesResponseV2Dto
from ...models.push_tracking_categories_v2_dto import PushTrackingCategoriesV2Dto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushTrackingCategoriesV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushTrackingCategoriesResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushTrackingCategoriesResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushTrackingCategoriesResponseV2Dto]
    """
