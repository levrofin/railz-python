...
from ...models.get_dispute_response_v2_dto import GetDisputeResponseV2Dto
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, DisputeStatus] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetDisputeResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetDisputeResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        id (Union[Unset, str]):
        status (Union[Unset, DisputeStatus]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetDisputeResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetDisputeResponseV2Dto]
    """
