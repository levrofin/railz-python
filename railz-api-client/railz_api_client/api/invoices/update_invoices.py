...
from ...models.update_invoice_response_v2_dto import UpdateInvoiceResponseV2Dto
from ...models.update_invoice_v2_dto import UpdateInvoiceV2Dto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/v2/accounting/invoices/{id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateInvoiceResponseV2Dto
    ]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = UpdateInvoiceResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateInvoiceResponseV2Dto]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, UpdateInvoiceResponseV2Dto]
    """
