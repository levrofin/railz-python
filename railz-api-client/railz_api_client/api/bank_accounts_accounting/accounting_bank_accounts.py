...
from ...models.get_bank_account_accounting_response_v2_dto import GetBankAccountAccountingResponseV2Dto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetBankAccountAccountingResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetBankAccountAccountingResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    `quickbooks` `xero` `quickbooksDesktop` `sageIntacct` `sageBusinessCloud` `dynamicsBusinessCentral`
    `zohoBooks`
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBankAccountAccountingResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBankAccountAccountingResponseV2Dto]
    """
