...
from ...models.push_bank_account_response_v2_dto import PushBankAccountResponseV2Dto
from ...models.push_bank_account_v2_dto import PushBankAccountV2Dto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushBankAccountV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushBankAccountResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushBankAccountResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushBankAccountResponseV2Dto]
    """
