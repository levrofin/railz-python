...
from ...models.get_transaction_response_v2_dto import GetTransactionResponseV2Dto
from ...models.transactions_status import TransactionsStatus
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, TransactionsStatus] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetTransactionResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetTransactionResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        id (Union[Unset, str]):
        status (Union[Unset, TransactionsStatus]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetTransactionResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetTransactionResponseV2Dto]
    """
