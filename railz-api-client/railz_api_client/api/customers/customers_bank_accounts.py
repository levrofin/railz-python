...
from ...models.get_customer_bank_account_response_v2_dto import GetCustomerBankAccountResponseV2Dto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCustomerBankAccountResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetCustomerBankAccountResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetCustomerBankAccountResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetCustomerBankAccountResponseV2Dto]
    """
