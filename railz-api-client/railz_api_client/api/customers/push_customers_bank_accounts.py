...
from ...models.push_customer_bank_account_dto import PushCustomerBankAccountDto
from ...models.push_customer_bank_account_response_dto import PushCustomerBankAccountResponseDto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushCustomerBankAccountDto,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/accounting/customers/bankAccounts",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushCustomerBankAccountResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushCustomerBankAccountResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushCustomerBankAccountResponseDto]
    """
