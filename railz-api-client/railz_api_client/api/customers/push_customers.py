...
from ...models.push_customer_v2_dto import PushCustomerV2Dto
from ...models.push_customer_v2_response_dto import PushCustomerV2ResponseDto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushCustomerV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[
        Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushCustomerV2ResponseDto
    ]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PushCustomerV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushCustomerV2ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushCustomerV2ResponseDto]
    """
