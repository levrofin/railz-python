...
from ...models.batch_push_update_journal_entries_v2_dto import BatchPushUpdateJournalEntriesV2Dto
from ...models.batch_update_journal_entries_v2_response_dto import BatchUpdateJournalEntriesV2ResponseDto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BatchUpdateJournalEntriesV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[BatchUpdateJournalEntriesV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[BatchUpdateJournalEntriesV2ResponseDto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
