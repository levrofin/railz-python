...
from ...models.push_vendor_v2_dto import PushVendorV2Dto
from ...models.push_vendor_v2_response_dto import PushVendorV2ResponseDto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushVendorV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushVendorV2ResponseDto]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PushVendorV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushVendorV2ResponseDto]]
    """
