...
from ...models.put_vendor_bank_account_dto import PutVendorBankAccountDto
from ...models.put_vendor_bank_account_response_dto import PutVendorBankAccountResponseDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/v2/accounting/vendors/bankAccounts/{id}",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PutVendorBankAccountResponseDto.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PutVendorBankAccountResponseDto]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PutVendorBankAccountResponseDto]
    """
