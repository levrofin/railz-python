...
from ...models.push_vendor_bank_account_dto import PushVendorBankAccountDto
from ...models.push_vendor_bank_account_response_dto import PushVendorBankAccountResponseDto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushVendorBankAccountDto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushVendorBankAccountResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushVendorBankAccountResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushVendorBankAccountResponseDto]
    """
