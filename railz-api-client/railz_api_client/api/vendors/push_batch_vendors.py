...
from ...models.batch_push_vendor_response_v2_dto import BatchPushVendorResponseV2Dto
from ...models.batch_push_vendor_v2_dto import BatchPushVendorV2Dto
...
def _get_kwargs(
    *,
    body: BatchPushVendorV2Dto,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/accounting/vendors/batch",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BatchPushVendorResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[BatchPushVendorResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[BatchPushVendorResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
