...
from ...models.estimates_status import EstimatesStatus
from ...models.get_estimate_response_v2_dto import GetEstimateResponseV2Dto
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, EstimatesStatus] = UNSET,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetEstimateResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetEstimateResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        status (Union[Unset, EstimatesStatus]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetEstimateResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetEstimateResponseV2Dto]
    """
