...
from ...models.get_invoice_credit_note_response_v2_dto import GetInvoiceCreditNoteResponseV2Dto
from ...models.invoice_credit_notes_status import InvoiceCreditNotesStatus
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetInvoiceCreditNoteResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetInvoiceCreditNoteResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetInvoiceCreditNoteResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetInvoiceCreditNoteResponseV2Dto]
    """
