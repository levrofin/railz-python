...
from ...models.push_invoice_credit_note_v2_dto import PushInvoiceCreditNoteV2Dto
from ...models.push_invoice_credit_note_v2_response_dto import PushInvoiceCreditNoteV2ResponseDto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushInvoiceCreditNoteV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushInvoiceCreditNoteV2ResponseDto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    `quickbooks` `xero` `freshbooks` `sageBusinessCloud` `oracleNetsuite` `dynamicsBusinessCentral`
    `zohoBooks`
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushInvoiceCreditNoteV2ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushInvoiceCreditNoteV2ResponseDto]
    """
