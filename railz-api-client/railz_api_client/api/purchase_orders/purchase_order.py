...
from ...models.get_purchase_order_response_v2_dto import GetPurchaseOrderResponseV2Dto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetPurchaseOrderResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetPurchaseOrderResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    `quickbooks` `xero` `quickbooksDesktop` `sageIntacct` `oracleNetsuite` `dynamicsBusinessCentral`
    `zohoBooks`
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetPurchaseOrderResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetPurchaseOrderResponseV2Dto]
    """
