...
from ...models.push_invoice_payment_response_v2_dto import PushInvoicePaymentResponseV2Dto
from ...models.push_invoice_payment_v2_dto import PushInvoicePaymentV2Dto
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: PushInvoicePaymentV2Dto,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = PushInvoicePaymentResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushInvoicePaymentResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, PushInvoicePaymentResponseV2Dto]
    """
