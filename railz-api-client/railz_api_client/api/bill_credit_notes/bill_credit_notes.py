...
from ...models.bill_credit_notes_status import BillCreditNotesStatus
...
from ...models.get_bill_credit_note_response_v2_dto import GetBillCreditNoteResponseV2Dto
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, BillCreditNotesStatus] = UNSET,
    ...
    params["remainingCredit"] = remaining_credit
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetBillCreditNoteResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = GetBillCreditNoteResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    `quickbooks` `xero` `quickbooksDesktop` `sageIntacct` `sageBusinessCloud` `oracleNetsuite`
    `zohoBooks`
    ...
    Args:
        ...
        status (Union[Unset, BillCreditNotesStatus]):
    ...
    Returns:
        Response[Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBillCreditNoteResponseV2Dto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto, GetBillCreditNoteResponseV2Dto]
    """
