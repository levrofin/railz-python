...
from ...models.business_valuations_reconstruct import BusinessValuationsReconstruct
...
def _get_kwargs(
    *,
    ...
    reconstruct: Union[Unset, BusinessValuationsReconstruct] = "false",
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = BusinessValuationResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = BusinessValuationResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        reconstruct (Union[Unset, BusinessValuationsReconstruct]):  Default: 'false'.
    ...
    Returns:
        Response[Union[Any, BusinessValuationResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BusinessValuationResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
