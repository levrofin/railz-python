...
from ...models.credit_scores_reconstruct import CreditScoresReconstruct
from ...models.credit_scores_response_v2_dto import CreditScoresResponseV2Dto
...
def _get_kwargs(
    *,
    ...
    reconstruct: Union[Unset, CreditScoresReconstruct] = "false",
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = CreditScoresResponseV2Dto.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.ACCEPTED:
        response_202 = CreditScoresResponseV2Dto.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        reconstruct (Union[Unset, CreditScoresReconstruct]):  Default: 'false'.
    ...
    Returns:
        Response[Union[Any, CreditScoresResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, CreditScoresResponseV2Dto, Error400ResponseDtoV2, Error401ResponseDto, Error403ResponseDto, Error500ResponseDto]
    """
